...
class Config:
    ...
    # ---- Paths ------------------------------------------------------------
    # Use a valid local folder (e.g., inside your project directory)
    metadata_db_path: str = "danbooru2024/metadata.parquet"
    output_dir: str = "danbooru2024/images"
    ...
    tags_col: str = "tag_string"  # This is the actual column name used in Danbooru parquet
    ...
    width_col: str = "image_width"                    # Changed from "image_width"
    height_col: str = "image_height"                  # Changed from "image_height"
